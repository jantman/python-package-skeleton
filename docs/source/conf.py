# -*- coding: utf-8 -*-
#
# python-package-skeleton documentation build configuration file, created by
...
from python-package-skeleton.version import _VERSION
...
if is_rtd:
    ...
    htmlhelp_basename = 'python-package-skeletondoc'
...
latex_documents = [
  (master_doc, 'python-package-skeleton.tex', u'python-package-skeleton Documentation',
...
man_pages = [
    (master_doc, 'python-package-skeleton', u'python-package-skeleton Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'python-package-skeleton', u'python-package-skeleton Documentation',
   author, 'python-package-skeleton', 'One line description of project.',
   'Miscellaneous'),
]
